...
namespace Competition.Data.Migrations
{
    ...
    [Migration("20260811101739_AddGlobalAwardPointSystemsAndClosure")]
    partial class AddGlobalAwardPointSystemsAndClosure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Competition.Domain.AwardPointSystem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Competition.Domain.CompetitionDiscipline", b =>
                {
                    ...
                    b.Property<long?>("AwardPointSystemId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Competition.Domain.RankingPointRule", b =>
                {
                    ...
                    b.HasIndex("AwardPointSystemId", "Rank")
                        .IsUnique();
            ...
            modelBuilder.Entity("Competition.Domain.CompetitionDiscipline", b =>
                {
                    b.HasOne("Competition.Domain.AwardPointSystem", "AwardPointSystem")
                        .WithMany("CompetitionDisciplines")
                        .HasForeignKey("AwardPointSystemId")
